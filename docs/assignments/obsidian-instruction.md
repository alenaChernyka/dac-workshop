...
2. Добавьте свойства в заметку.
    ...
    ![Скриншот палитры команд с текстом «свойство» в окне поиска](../images/properties-window.png)

    2.2. Выберите «Добавить свойство файла».

    Под заголовком заметки появится панель со свойствами.

    ![Скриншот панели свойств с выбором нового свойства](../images/properties-panel.png)

    !!! note "Если не получилось"
    ...
    ![Скриншот панели свойств с созданным свойством без значения](../images/properties-made.png)

    2.4. Нажмите на кнопку с тремя полосками ![Выбор типа][property-type-icon] рядом с названием свойства. 

    ![Скриншот панели свойств с указанием на кнопку выбора типа](../images/properties-type.png)

    2.5. В раскрывшемся списке откройте **Тип свойства**. Выберите тип из предложенных вариантов: например, **Флажок**.

     ![Скриншот панели свойств с вариантами типов](../images/properties-type-made.png)
    ...
    ![Скриншот панели свойств с кнопкой добавления](../images/properties-new.png)
...
3. Добавьте фильтр для отображения только ежедневных заметок.
    ...
    ![Скриншот панели настроек базы](../images/base-settings.png)

    3.2. В поле фильтра оставьте свойство **File** (Файл), поставьте условие **in folder** и выберите папку с ежедневными заметками.

    ![Скриншот установки фильтра в базе](../images/base-filter.png)
...
4. Добавьте заданные в шаблоне свойства, которые вы хотите отслеживать и просматривать на общей странице базы ежедневных заметок.
    ...
    ![Скриншот выбора свойств](../images/base-properties.png)
...
5. Добавьте сортировку по дате.
    ...
    ![Скриншот сортировки базы](../images/base-sort.png)
...
[built-in-icon]: ../images/built-in-plugins-icon.png

[settings-icon]: ../images/settings-icon.png

[property-type-icon]: ../images/property-type-icon.png

[daily-note-icon]: ../images/daily-note-icon.png

[base-icon]: ../images/base-icon.png

[filter-icon]: ../images/filter-icon.png

[properties-icon]: ../images/properties-icon.png

[sort-icon]: ../images/sort-icon.png

[date-icon]: ../images/date-icon.png

[view-icon]: ../images/view-icon.png

[add-icon]: ../images/add-icon.png

[obsidian-help]: [https://obsidian.md/ru/help](https://obsidian.md/ru/help)

[obsidian-help-daily-notes]: [https://obsidian.md/ru/help/plugins/daily-notes](https://obsidian.md/ru/help/plugins/daily-notes)

[obsidian-help-bases-views]: [https://obsidian.md/ru/help/bases/views](https://obsidian.md/ru/help/bases/views)

[daily-notes-guide]: [https://www.obsibrain.com/blog/mastering-obsidian-daily-notes-a-complete-guide](https://www.obsibrain.com/blog/mastering-obsidian-daily-notes-a-complete-guide)